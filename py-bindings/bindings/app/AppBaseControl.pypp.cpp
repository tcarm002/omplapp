...
void register_AppBaseControl_class(){
    ...
    { //::ompl::app::AppBase< (ompl::app::AppType)1 >
        ...
        { //::ompl::app::AppBase< (ompl::app::AppType)1 >::setOptimizationObjectiveAndThreshold
            ...
            AppBaseControl_exposer.def( 
                ...
                , setOptimizationObjectiveAndThreshold_function_type( &::ompl::app::AppBase< (ompl::app::AppType)1 >::setOptimizationObjectiveAndThreshold )
