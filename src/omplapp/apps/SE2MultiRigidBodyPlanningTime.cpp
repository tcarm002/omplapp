...
#include "omplapp/apps/SE2MultiRigidBodyPlanningTime.h"

ompl::app::SE2MultiRigidBodyPlanningTime::SE2MultiRigidBodyPlanningTime(unsigned int n) :
    AppBase<GEOMETRIC>(base::StateSpacePtr(new base::CompoundStateSpace()), Motion_2D), n_(n)
{
    assert (n > 0);
    name_ = "Multi rigid body planning (2D)";
    // Adding TimeStateSpace
...
void ompl::app::SE2MultiRigidBodyPlanningTime::inferEnvironmentBounds(void)
{
...
void ompl::app::SE2MultiRigidBodyPlanningTime::inferProblemDefinitionBounds(void)
{
...
ompl::base::ScopedState<> ompl::app::SE2MultiRigidBodyPlanningTime::getDefaultStartState(void) const
{
...
const ompl::base::State* ompl::app::SE2MultiRigidBodyPlanningTime::getGeometricComponentStateInternal(const ompl::base::State* state, unsigned int index) const
{
    assert (index < n_);
